...
class Seniority_committee:
    ...
    def make_hyperplane(self, class_num, X_train, number_of_hyperplane, c=0.1, cycle_range=100, disp=False, \
...
#             self.weights_hp_3 = hyperplane_coefficients
    ...
    def fit(self, X, y):
        ...
        self.X_train = X
        self.y_train = y
        self.optim_params[1] = {'cycle_range': 100, 'disp': False, 'adaptive': True, 'maxiter': None, 'xatol': None}
        self.optim_params[2] = {'cycle_range': 1000, 'disp': False, 'adaptive': True, 'maxiter': 100, 'xatol': 0.3}
        self.optim_params[3] = {'cycle_range': 100, 'disp': False, 'adaptive': True, 'maxiter': 10, 'xatol': 1}
        ...
        for hp_num in range(1, 4):
            ...
            while True:
                ...
                hp_weights_class_1 = make_hyperplane(class_num=1, self.X_train, number_of_hyperplane=hp_num, \
                                                     c=0.1, cycle_range=optim_params[hp_num]['cycle_range'], \
                                                     disp=optim_params[hp_num]['disp'], \
                                                     adaptive=optim_params[hp_num]['adaptive'], \
                                                     maxiter=optim_params[hp_num]['maxiter'], \
                                                     xatol=optim_params[hp_num]['xatol'])
